...
ros::Publisher pub1;
beginner_tutorial::msgModeling_data model_msg;
...
{ 
  if(true == VrpnStartFlag){

	model_msg.imu_time_msg  = imu_time;        
	model_msg.imu_angx_msg  = imu_box[2];
        model_msg.imu_angy_msg  = imu_box[3];
        model_msg.imu_angz_msg  = imu_box[4];
        model_msg.imu_linx_msg  = imu_box[5];
        model_msg.imu_liny_msg  = imu_box[6];
        model_msg.imu_linz_msg  = imu_box[7];
	model_msg.vrpn_time_msg = vrpn_time;
	model_msg.vrpn_posx_msg = vrpn_box[2];
	model_msg.vrpn_posy_msg = vrpn_box[3];
	model_msg.vrpn_posz_msg = vrpn_box[4];
		model_msg.vrpn_orix_msg = vrpn_box[5];
	model_msg.vrpn_oriy_msg = vrpn_box[6];
	model_msg.vrpn_oriz_msg = vrpn_box[7];
	model_msg.vrpn_oriw_msg = vrpn_box[8];	
	}
}
...
ros::init(argc, argv, "modeling_data");
  ...
  pub1  = esti.advertise<beginner_tutorials::msgModeling_data>("modeling_data_msg",100);
