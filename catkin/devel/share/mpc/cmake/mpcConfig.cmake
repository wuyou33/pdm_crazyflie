...
if("TRUE" STREQUAL "TRUE")
  set(mpc_SOURCE_PREFIX /home/loic_dubois/Documents/pdm_crazyflie/catkin/src/mpc)
  set(mpc_DEVEL_PREFIX /home/loic_dubois/Documents/pdm_crazyflie/catkin/devel)
  set(mpc_INSTALL_PREFIX "")
  set(mpc_PREFIX ${mpc_DEVEL_PREFIX})
else()
  set(mpc_SOURCE_PREFIX "")
  set(mpc_DEVEL_PREFIX "")
  set(mpc_INSTALL_PREFIX /home/loic_dubois/Documents/pdm_crazyflie/catkin/install)
...
if(NOT "/home/loic_dubois/Documents/pdm_crazyflie/catkin/devel/include;/home/loic_dubois/Documents/pdm_crazyflie/catkin/src/mpc/include " STREQUAL " ")
  set(mpc_INCLUDE_DIRS "")
  set(_include_dirs "/home/loic_dubois/Documents/pdm_crazyflie/catkin/devel/include;/home/loic_dubois/Documents/pdm_crazyflie/catkin/src/mpc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mpc' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'formation <formation@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mpc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/loic_dubois/Documents/pdm_crazyflie/catkin/src/mpc/${idir}'.  Ask the maintainer 'formation <formation@todo.todo>' to fix it.")
    endif()
