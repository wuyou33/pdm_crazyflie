...
if("TRUE" STREQUAL "TRUE")
  set(mpc_SOURCE_PREFIX /home/formation/catkin_ws/src/mpc)
  set(mpc_DEVEL_PREFIX /home/formation/catkin_ws/devel)
  set(mpc_INSTALL_PREFIX "")
  set(mpc_PREFIX ${mpc_DEVEL_PREFIX})
else()
  set(mpc_SOURCE_PREFIX "")
  set(mpc_DEVEL_PREFIX "")
  set(mpc_INSTALL_PREFIX /home/formation/catkin_ws/install)
...
if(NOT "/home/formation/catkin_ws/devel/include;/home/formation/catkin_ws/src/mpc/include " STREQUAL " ")
  set(mpc_INCLUDE_DIRS "")
  set(_include_dirs "/home/formation/catkin_ws/devel/include;/home/formation/catkin_ws/src/mpc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/formation/catkin_ws/src/mpc/${idir}'.  Ask the maintainer 'formation <formation@todo.todo>' to fix it.")
    endif()
...
set(mpc_EXPORTED_TARGETS "mpc_generate_messages_cpp;mpc_generate_messages_lisp;mpc_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mpc_dep}_FOUND)
      find_package(${mpc_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mpc_dep} REQUIRED ${depend_list})
  endif()
