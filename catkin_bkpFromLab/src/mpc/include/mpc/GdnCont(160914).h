...
public:
	...
	Eigen::MatrixXd GdnCont(Eigen::Matrix<double,NUM_IMPUT*N,1> U,double pos[3], double vel[3]);
...
protected:
	...
	Eigen::Matrix<double,NUM_STATE,NUM_STATE> C_ob;
	Eigen::Matrix<double,NUM_STATE,NUM_STATE> D_ob;	
