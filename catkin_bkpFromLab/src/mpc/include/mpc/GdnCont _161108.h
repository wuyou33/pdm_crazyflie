...
//20161026オブザーバゲイン変更前
/*	//A_ob
	A_ob(0,0) = 0.9993;		A_ob(0,1) = 0.0100;	A_ob(0,2) = 0.000049378; 
	A_ob(1,0) = -0.000023855;	A_ob(1,1) = 0.9997;	A_ob(1,2) = 0.0099; 
	A_ob(2,0) = 0.000045143;	A_ob(2,1) = -0.0559;	A_ob(2,2) = 0.9706;
	A_ob(3,3) = 0.9993;		A_ob(3,4) = 0.0100;	A_ob(3,5) = 0.000049378; 
	A_ob(4,3) = -0.000023855;	A_ob(4,4) = 0.9997;	A_ob(4,5) = 0.0099; 
	A_ob(5,3) = 0.000045143;	A_ob(5,4) = -0.0559;	A_ob(5,5) = 0.9706;
	A_ob(6,6) = 1.0;		A_ob(6,7) = 0.01;	A_ob(6,8) = 0.000049205;
	A_ob(7,6) = -0.00000000013391;	A_ob(7,7) = 0.9996;	A_ob(7,8) = 0.0098;
	A_ob(8,6) = 0.00000000020484;	A_ob(8,7) = -0.0713;	A_ob(8,8) = 0.9527;
 
	//B_ob
	B_ob(0,0) = 0.00069357;		B_ob(0,1) = 0.000024315;		B_ob(0,2) = 0.000000065476;
	B_ob(1,0) = 0.000023855;	B_ob(1,1) = 0.000046925;		B_ob(1,2) = 0.000019645;
	B_ob(2,0) = -0.000045143;	B_ob(2,1) = -0.0000011795;		B_ob(2,2) = 0.0039;
	B_ob(3,3) = 0.00069357;		B_ob(3,4) = 0.000024315;		B_ob(3,5) = 0.000000065476;
	B_ob(4,3) = 0.000023855;	B_ob(4,4) = 0.000046925;		B_ob(4,5) = 0.000019645;
	B_ob(5,3) = -0.000045143;	B_ob(5,4) = -0.0000011795;		B_ob(5,5) = 0.0039;
	B_ob(6,6) = 0.0000016427;	B_ob(6,7) = 0.00000000013595;		B_ob(6,8) = 0.00000000019761;
	B_ob(7,6) = 0.00000000013391;	B_ob(7,7) = 0.00000000020486;		B_ob(7,8) = 0.000000059046;
	B_ob(8,6) = -0.00000000020484;	B_ob(8,7) = -0.0000000000073614;	B_ob(8,8) = 0.000011714;
*/
...
Eigen::MatrixXd CGdnCont::GdnCont(double pos[3],double vel[3],int signal,double next_ref_x,double next_ref_y,double next_ref_z)
{
	...
	//同一次元オブザーバ(20160907)
	U_ob << pos[0],			//U_ob = [x,y,z,vx,vy,vz,φ,θ,T]'
		pos[1],
		-1.0 * pos[2],
		vel[0],
		vel[1],
	...
	Xe_ob = X_ob;			//Xe_ob,X_ob = [x,y,z,vx,vy,vz,ax,ay,az]'
